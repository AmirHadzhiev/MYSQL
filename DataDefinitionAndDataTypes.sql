...
INSERT INTO `gamebar`.`employees`( `first_name`, `last_name`)VALUES ( "Pesho","Pesho");
INSERT INTO  `gamebar`.`employees`( `first_name`, `last_name`)VALUES ( "Gosho","Gosho"),("Gergana","Gergana");

ALTER TABLE `gamebar`.`employees` ADD `middle_name` VARCHAR(100);
